...
├── contatti.html     → Contatti e Dove Siamo
├── style.css         → Foglio di Stile Globale
└── images/           → Fotografie del vivaio
```
...
- [ ] Aggiornare il **numero di telefono** WhatsApp nei link `wa.me/39`
- [ ] Aggiornare l'**indirizzo esatto** del vivaio
- [ ] Aggiungere la **mappa Google Maps** nella pagina Contatti (iframe)
- [ ] Aggiungere la **P.IVA** nel footer
- [ ] Configurare un sistema di invio email per il modulo (es. Formspree)
- [ ] Aggiungere la vera **email** e **PEC** aziendale
